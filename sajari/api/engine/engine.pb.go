...
type EngineClient interface {
	// Create a collection.
	CreateCollection(ctx context.Context, in *Collection, opts ...grpc.CallOption) (*sajari_rpc.Empty, error)
	// Deletes all resources associated with this collection. Collections must first
	// be unloaded before they can be deleted.
	DeleteCollection(ctx context.Context, in *Collection, opts ...grpc.CallOption) (*sajari_rpc.Empty, error)
}
...
func (c *engineClient) CreateCollection(ctx context.Context, in *Collection, opts ...grpc.CallOption) (*sajari_rpc.Empty, error) {
...
func (c *engineClient) DeleteCollection(ctx context.Context, in *Collection, opts ...grpc.CallOption) (*sajari_rpc.Empty, error) {
	out := new(sajari_rpc.Empty)
...
type EngineServer interface {
	// Create a collection.
	CreateCollection(context.Context, *Collection) (*sajari_rpc.Empty, error)
	// Deletes all resources associated with this collection. Collections must first
	// be unloaded before they can be deleted.
	DeleteCollection(context.Context, *Collection) (*sajari_rpc.Empty, error)
}
...
var fileDescriptor0 = []byte{
	...
	0x3d, 0x57, 0x90, 0xc5, 0x20, 0x53, 0x5c, 0x52, 0x73, 0x52, 0x29, 0x33, 0x25, 0x89, 0x0d, 0xec,
	0x7e, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x85, 0x8a, 0x8f, 0xf0, 0x0c, 0x01, 0x00, 0x00,
}
