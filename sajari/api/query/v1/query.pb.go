...
import fmt "fmt"
import math "math"
import sajari_engine_query_v1 "code.sajari.com/protogen-go/sajari/engine/query/v1"
...
type AnalyseRequest struct {
	AnalyseRequest *sajari_engine_query_v1.AnalyseRequest `protobuf:"bytes,1,opt,name=analyse_request,json=analyseRequest" json:"analyse_request,omitempty"`
}
...
func (*AnalyseRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }

func (m *AnalyseRequest) GetAnalyseRequest() *sajari_engine_query_v1.AnalyseRequest {
	if m != nil {
...
type AnalyseResponse struct {
	AnalyseResponse *sajari_engine_query_v1.AnalyseResponse `protobuf:"bytes,1,opt,name=analyse_response,json=analyseResponse" json:"analyse_response,omitempty"`
}
...
func (*AnalyseResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }

func (m *AnalyseResponse) GetAnalyseResponse() *sajari_engine_query_v1.AnalyseResponse {
	if m != nil {
...
func (c *queryClient) Analyse(ctx context.Context, in *AnalyseRequest, opts ...grpc.CallOption) (*AnalyseResponse, error) {
	...
	err := grpc.Invoke(ctx, "/sajari.api.query.v1.Query/Analyse", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	,
}
