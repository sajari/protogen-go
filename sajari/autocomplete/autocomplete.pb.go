...
type AdminClient interface {
	...
	Create(ctx context.Context, in *Model, opts ...grpc.CallOption) (*sajari_engine.Empty, error)
	// Delete an existing model
	Delete(ctx context.Context, in *Model, opts ...grpc.CallOption) (*sajari_engine.Empty, error)
}
...
func (c *adminClient) Create(ctx context.Context, in *Model, opts ...grpc.CallOption) (*sajari_engine.Empty, error) {
...
func (c *adminClient) Delete(ctx context.Context, in *Model, opts ...grpc.CallOption) (*sajari_engine.Empty, error) {
	out := new(sajari_engine.Empty)
...
type AdminServer interface {
	// Create a new autocomplete model.
	Create(context.Context, *Model) (*sajari_engine.Empty, error)
	// Delete an existing model
	Delete(context.Context, *Model) (*sajari_engine.Empty, error)
}
...
type TrainClient interface {
	...
	TrainCorpus(ctx context.Context, in *TrainCorpusRequest, opts ...grpc.CallOption) (*sajari_engine.Empty, error)
	// Train queries (used to assist with query popularity prediction).
	TrainQuery(ctx context.Context, in *TrainQueryRequest, opts ...grpc.CallOption) (*sajari_engine.Empty, error)
}
...
func (c *trainClient) TrainCorpus(ctx context.Context, in *TrainCorpusRequest, opts ...grpc.CallOption) (*sajari_engine.Empty, error) {
	out := new(sajari_engine.Empty)
...
func (c *trainClient) TrainQuery(ctx context.Context, in *TrainQueryRequest, opts ...grpc.CallOption) (*sajari_engine.Empty, error) {
	out := new(sajari_engine.Empty)
...
type TrainServer interface {
	// Train the corpus (used for spell correction).
	TrainCorpus(context.Context, *TrainCorpusRequest) (*sajari_engine.Empty, error)
	// Train queries (used to assist with query popularity prediction).
	TrainQuery(context.Context, *TrainQueryRequest) (*sajari_engine.Empty, error)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
